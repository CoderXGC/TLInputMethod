...
public class QKInputViewGroup extends NonScrollViewGroup {
    ...
    private final float TEXTSIZE_RATE_MAIN = (float) 1.2;
...
//        clearAnimation();
    ...
    private boolean keyboardOnTouchEvent(View view, MotionEvent motionEvent) throws Exception {
        View upLightView;
        ...
        switch (motionEvent.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (motionEvent.getY() < 0) {
                    ...
                    Global.redoText_single.clear();
                    Log.d("输入文字9",alphabet.substring(index, index + 1));
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (motionEvent.getY() < view.getY() && !mLightShow) {
                    ...
                    Log.d("输入文字6", InputMode.halfToFull(commitText));
    ...
    private View.OnTouchListener qkInputOnTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            try {
                a= keyboardOnTouchEvent(view, motionEvent);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return  a;
    ...
    private boolean smileOnTouchEvent(View v, MotionEvent event) throws Exception {
    ...
    private boolean deleteOnTouchEvent(View v, MotionEvent event) throws Exception {
