...
public class QuickSymbolViewGroup extends ScrolledViewGroup implements QuickSymbolInterface, ViewGroupInterface {
    ...
    public void updateSymbolsFromFile() throws Exception {
        symbols = loadSymbolFromFile("default");
        updateCurrentSymbolsAndSetTheContent(currentSymbolFlag);
    }
    ...
    public QuickSymbolsDataStruct loadSymbolFromFile(String symbolModeName) throws Exception {
    ...
    public void writeSymbolsToFile(String symbolModeName, QuickSymbolsDataStruct symbolsDataStruct) throws Exception {
        String flagstring = ".Symbols";
        FileManager fileManager = FileManager.getInstance();
