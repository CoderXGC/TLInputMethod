...
public class FileManager {
    ...
    private String readContentFromFile(String filename) throws Exception {
        File file = new File(
    ...
    public List<Integer> readIntegerListFromFile(String filename) throws Exception {
    ...
    public String[] readStringArrayFromFile(String filename) throws Exception {
        String contentString = readContentFromFile(filename);
        String[] strings = contentString.split(fileContentSeparator);
        return strings;
    }

    public void writeToFile(String filename, String texts) throws Exception {
        File file = new File(
                filePath + File.separator
                        + filename
        );
    ...
    public void writeToFile(String filename, int[] values) throws Exception {
        File file = new File(
                filePath + File.separator
                        + filename
        );
    ...
    public void writeToFile(String filename, List<Integer> values) throws Exception {
        File file = new File(
                filePath + File.separator
                        + filename
        );
